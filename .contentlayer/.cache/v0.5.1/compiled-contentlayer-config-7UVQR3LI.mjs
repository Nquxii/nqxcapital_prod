...
var require_siteMetadata = __commonJS({
  "data/siteMetadata.js"(exports, module) {
    var siteMetadata2 = {
      title: "nqx capital",
      author: "Nqx",
      headerTitle: "NQX Capital",
      description: "Est. 2024",
      language: "en-us",
      theme: "dark",
      // system, dark or light
      siteUrl: "https://tailwind-nextjs-starter-blog.vercel.app",
      siteRepo: "https://github.com/timlrx/tailwind-nextjs-starter-blog",
      siteLogo: `${process.env.BASE_PATH || ""}/static/images/soros_newspaper.png`,
...
//# sourceMappingURL=compiled-contentlayer-config-7UVQR3LI.mjs.map
